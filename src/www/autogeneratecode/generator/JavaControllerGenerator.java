...
public class JavaControllerGenerator extends JavaFileGenerator {
	...
	public JavaControllerGenerator(PsiJavaFileImpl psiJavaFileImpl, String packageName) {
	...
	public File write(File dir) throws IOException {
		...
		File file = new File(dir, psiClass.getName() +"Controller"+ ".java");
...
//		sb.append(getCommentContent(comment, "", "Controller of "));
		...
		sb.append(getAnnotate(psiAnnotation,"","Controller of "));
...
//		Field[] fields = javaClass.getFields();
		...
		int i = 0;
		for (PsiField field : psiAllFields) {
			...
			psiAnnotation = field.getAnnotation("www.autogeneratecode.model.Comment");
